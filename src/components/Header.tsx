...
export default function Header() {
  ...
  return (
    <header className="bg-white shadow-sm border-b border-gray-200" role="banner" id="navigation">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <Link 
              ...
              aria-label="Event Check-in Home"
            >
          ...
          <nav className="flex items-center" role="navigation" aria-label="User navigation">
            {isSignedIn ? (
              <div className="relative">
                <UserButton 
                  appearance={{
                    elements: {
                      avatarBox: "focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded-full"
                    }
                  }}
                />
              </div>
